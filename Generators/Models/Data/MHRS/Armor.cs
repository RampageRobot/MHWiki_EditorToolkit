...
namespace MediawikiTranslator.Models.Data.MHRS
{
	...
	public partial class Armor
	{
		...
		public static ArmorParam[] GetArmors()
		{
			...
			Dictionary<string, ArmorMsgMsg> armMessages = ArmorMsg.FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\arm\a_arm_name.msg.539100710.json")).Msgs;
			Dictionary<string, ArmorMsgMsg> armMessagesMR = ArmorMsg.FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\arm\a_arm_name_mr.msg.539100710.json")).Msgs;
			Dictionary<string, ArmorMsgMsg> armMessagesExplain = ArmorMsg.FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\arm\a_arm_explain.msg.539100710.json")).Msgs;
			Dictionary<string, ArmorMsgMsg> armMessagesExplainMR = ArmorMsg.FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\arm\a_arm_explain_mr.msg.539100710.json")).Msgs;
			Dictionary<string, ArmorMsgMsg> chestMessages = ArmorMsg.FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\chest\a_chest_name.msg.539100710.json")).Msgs;
			Dictionary<string, ArmorMsgMsg> chestMessagesMR = ArmorMsg.FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\chest\a_chest_name_mr.msg.539100710.json")).Msgs;
			Dictionary<string, ArmorMsgMsg> chestMessagesExplain = ArmorMsg.FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\chest\a_chest_explain.msg.539100710.json")).Msgs;
			Dictionary<string, ArmorMsgMsg> chestMessagesExplainMR = ArmorMsg.FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\chest\a_chest_explain_mr.msg.539100710.json")).Msgs;
			Dictionary<string, ArmorMsgMsg> headMessages = ArmorMsg.FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\head\a_head_name.msg.539100710.json")).Msgs;
			Dictionary<string, ArmorMsgMsg> headMessagesMR = ArmorMsg.FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\head\a_head_name_mr.msg.539100710.json")).Msgs;
			Dictionary<string, ArmorMsgMsg> headMessagesExplain = ArmorMsg.FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\head\a_head_explain.msg.539100710.json")).Msgs;
			Dictionary<string, ArmorMsgMsg> headMessagesExplainMR = ArmorMsg.FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\head\a_head_explain_mr.msg.539100710.json")).Msgs;
			Dictionary<string, ArmorMsgMsg> legMessages = ArmorMsg.FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\leg\a_leg_name.msg.539100710.json")).Msgs;
			Dictionary<string, ArmorMsgMsg> legMessagesMR = ArmorMsg.FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\leg\a_leg_name_mr.msg.539100710.json")).Msgs;
			Dictionary<string, ArmorMsgMsg> legMessagesExplain = ArmorMsg.FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\leg\a_leg_explain.msg.539100710.json")).Msgs;
			Dictionary<string, ArmorMsgMsg> legMessagesExplainMR = ArmorMsg.FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\leg\a_leg_explain_mr.msg.539100710.json")).Msgs;
			Dictionary<string, ArmorMsgMsg> waistMessages = ArmorMsg.FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\waist\a_waist_name.msg.539100710.json")).Msgs;
			Dictionary<string, ArmorMsgMsg> waistMessagesMR = ArmorMsg.FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\waist\a_waist_name_mr.msg.539100710.json")).Msgs;
			Dictionary<string, ArmorMsgMsg> waistMessagesExplain = ArmorMsg.FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\waist\a_waist_explain.msg.539100710.json")).Msgs;
			Dictionary<string, ArmorMsgMsg> waistMessagesExplainMR = ArmorMsg.FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\waist\a_waist_explain_mr.msg.539100710.json")).Msgs;
			Dictionary<string, ArmorMsgMsg> seriesNames = ArmorMsg.FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\armorseries_hunter_name.msg.539100710.json")).Msgs;
			Dictionary<string, ArmorMsgMsg> seriesNamesMR = ArmorMsg.FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\armorseries_hunter_name_mr.msg.539100710.json")).Msgs;
			ArmorParam[] armorData = FromJson(Utilities.ReadAllText(@"D:\MH_Data Repo\MH_Data\Parsed Files\MHRS\natives\stm\data\define\player\armor\armorbasedata.user.2.json")).SnowDataArmorBaseUserData.Param;
